...
We now provide theoretical guarantees and their proof sketches for our proposed algorithm. For brevity, here we omit the proofs and supporting definitions and lemmas that are discussed in detail in the longer version of our paper available on author's website \footnote{\url{http://virajshah.me/},\url{http://home.engineering.iastate.edu/~chinmay/}}.
